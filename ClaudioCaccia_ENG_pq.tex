...
\cventry{2012--Present}{Simulation Engineer}{Atos S.p.A.}{Sesto Calende}{employee}{Progettazione, dimensionamento e verifica di elettrovalvole oleodinamiche, ottimizzazione delle performance mediante strumenti di \emph{Virtual Prototyping}.\newline{}
	In particolare:
	\begin{itemize}
		\item Simulazione fluidodinamica (\emph{CFD}) fine di:
		\begin{itemize}
			\item stimare le \emph{performance} di componenti nuovi
			\item ottimizzare le portate di componenti esistenti
...
\cventry{2008--2012}{Firmware Engineer}{Atos S.p.A.}{Sesto Calende}{employee}{Sviluppo Firmware di attuatori elettroidraulici per il controllo di portata, di pressione, di forza e di posizione.
In particolare:
\begin{itemize}
...
\cventry{2007--2008}{Research Assistant}{Universit\`a di Milano Bicocca}{Dipartimento di Informatica}{}
